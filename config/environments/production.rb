Rails.application.configure do
  ...
  config.action_mailer.default_url_options = {:host => 'pgss15cs.herokuapp.com', :protocol => 'http'} #I've also tried it without ":protocol => 'http'"
  ...
  config.action_mailer.smtp_settings = {
      ...
      :user_name => 'pgss2014cs@gmail.com',
